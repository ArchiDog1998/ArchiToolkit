...
### ArchiToolkit.Pure.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [ArchiToolkit.Pure.Sample.csproj](../ArchiToolkit.Pure.Sample/ArchiToolkit.Pure.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### ArchiToolkit.Pure.Tests
