...
/// <summary>
/// Set the <see cref="GH_PersistentParam{T}.PersistentData"/> by using <see cref="GH_PersistentParam{T}.SetPersistentData(GH_Structure{T})"/>
...
/// <para><b>⚠ WARNING:</b> Please make sure that the <see cref="IGH_Param"/> of your parameter is a type of <see cref="GH_PersistentParam{T}"/>.</para>
/// </remarks>
/// <param name="propertyName">The <see langword="static"/> property or field that you want to set to your <see cref="GH_PersistentParam{T}"/>.</param>
...
/// <typeparam name="T">The <see langword="class"/> or <see langword="struct"/> that contains your <paramref name="propertyName"/>.</typeparam>
[AttributeUsage(AttributeTargets.Parameter)]
[Conditional(Constant.KeepAttributes)]
