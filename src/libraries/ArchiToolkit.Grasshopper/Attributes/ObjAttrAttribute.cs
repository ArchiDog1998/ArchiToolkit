...
/// <para><b>⚠ NOTICE:</b> If you want to make the <see cref="IGH_DocumentObject.Attributes"/> of all <see cref="IGH_Component"/> are <typeparamref name="T"/>, please use it on the assembly.</para>
/// </remarks>
