...
public readonly struct ParseResult(params IEnumerable<bool> results) : IEnumerable<bool>
{
    ...
    /// <returns></returns>
    public static implicit operator bool(ParseResult result) => result.Result;
    ...
    /// <param name="result"></param>
    /// <returns></returns>
    public static implicit operator ParseResult(bool result) => new(result);

    public IEnumerator<bool> GetEnumerator() => ((IEnumerable<bool>)Results).GetEnumerator();
