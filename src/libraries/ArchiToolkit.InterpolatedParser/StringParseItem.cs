...
public readonly unsafe struct StringParseItem<T> : IStringParseItem where T : IParsable<T>
{
    private readonly void* _ptr;
    private readonly IFormatProvider? _provider;
    public int RegexIndex { get; }

    public StringParseItem(in T value, int index, IFormatProvider? provider = null)
    {
