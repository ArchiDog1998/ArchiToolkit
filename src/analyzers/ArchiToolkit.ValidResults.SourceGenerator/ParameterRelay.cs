...
public class ParameterRelay(ITypeSymbol type, string name, RefKind kind)
{
    ...
    public ParameterSyntax GenerateParameter(bool isTracker, string trackerName, ITypeSymbol? containingType)
    {
        ...
        else if (isTracker)
        {
            ...
            {
                parameter = parameter.WithType(GenericName(Identifier("global::ArchiToolkit.ValidResults.ResultTracker"))
