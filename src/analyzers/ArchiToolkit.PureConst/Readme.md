...
in [ArchiToolkit.Pure.Sample.csproj](../ArchiToolkit.Pure.Sample/ArchiToolkit.Pure.Sample.csproj), they make sure that
the project is referenced as a set of analyzers.
