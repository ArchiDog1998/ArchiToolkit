...
namespace ArchiToolkit.QuantExtensions.SourceGenerator;
...

{
                ...
                return compilation.Assembly.GetAttributes()
                    .Where(attr =>
                    {
                        ...
                        return classType.ConstructUnboundGenericType().GetName().FullName is
                            "global::ArchiToolkit.QuantExtensions.NumberExtensionAttribute<,>";
                    });
            });
    ...
    private static void Generate(SourceProductionContext context, IEnumerable<AttributeData> attributes)
    {
        ...
        foreach (var attribute in attributes)
        {
            ...
            var nameSpace = NamespaceDeclaration("ArchiToolkit.QuantExtensions")
                .WithMembers([
